...
<acme:form>
	<acme:form-textbox code="administrator.configuration.form.label.words" path="words" readonly="false"/>
	<acme:form-textbox code="administrator.configuration.form.label.threshold" path="threshold" readonly="false"/>
